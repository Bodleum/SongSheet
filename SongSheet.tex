...
\begin{song}{Abide With Me}
    ...
    {\m{D}The \m{A}darkness \m{G}dee\m{D}pens; \m{Em}Lord, with \m{D}me \m{E7}a\mm{ - }\m{A}bide;}
...
\begin{song}{Cornerstone}
    ...
    \end
    \cp{'Cornerstone' Edward Mote, Eric Lilijero, Jonas Myrin, Reuben Morgan, William Bradbury\\{\copyright}2011 Hillsong Music Publishing}
\end{song}
...
%    \end
    \verse
    {I \m{Am}heard the voice of \m{C}Jesus \m{G}say,}
    {``Come \m{C}unto Me and \m{G}rest;}
    {Lay \m{Am}down, thou weary \m{C}one, lay \m{G}down}
    {Thy \m{F}head u\m{G}pon My \m{Am}breast.''}
    {I \m{C}came to Jesus \m{G}as I was,}
    {So \m{C}weary, worn and \m{G}sad;}
    {I \m{Am}found in Him a \m{C}resting \m{G}place,}
    {And \m{F}he has \m{G}made me \m{Am}glad}
    \end
    \verse
...
\begin{song}{In Christ Alone}
    ...
    \end
    \cp{'In Christ Alone' Keith Getty and Stuart Townend\\{\copyright}2001 Thankyou Music}
\end{song}
...
\begin{song}{Ten Thousand Reasons \extra{Bless The Lord}}
    \chorus
