...
\usepackage[left=1cm,right=1cm,top=0.75cm,bottom=1.8cm]{geometry}
\usepackage{xcolor}
\usepackage{fancyhdr}
\usepackage{hyperref}
\usepackage{makeidx}
...
\newcommand{\m}[2][l]{\if\musicmode 1\makebox[0pt][#1]{\begin{tabular}[b]{@{}l@{}}{\small\mdseries\color{chordColor}#2}\\\mbox{}\end{tabular}}\else\fi}

\begin{document}
\begin{titlepage}
    \begin{center}
        % \adjustbox{valign=m}%
        {\includegraphics[height=0.7\pageheight]{titleimage.png}}\\\vskip1em
